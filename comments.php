...
<?php if ( have_comments() ) : ?>
			<!-- alettieri NOTE: The following h3 id is left intact so that comments can be referenced on the page -->
			<h3 id="comments-title"><?php
			printf(  'One Response to %2$s', '%1$s Responses to %2$s', get_comments_number(),
